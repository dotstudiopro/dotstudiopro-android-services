    ...
    public void processJSONResponseObject(JSONObject response) {
        ...
        if(!isGeoBlocked) {
            ...
            try {
             ...
             /*   try {
                    description = obj.getString("ctv_description");
                    videoInfoDTO.setDescription(description);
                } catch (Exception e) {
                }*/
            ...
            /*if (videoInfoDTO.getAccessValue().equals("paywall") &&
                ...
                iVideoDetailsService_V2.callBackFromFetchVideoDetails(videoInfoDTOArrayList);
            } else {
                iVideoDetailsService_V2.getVideoDetailsServiceError(ApplicationConstants.DATA_MISSING_VIDEO);
            }
        } else {
            iVideoDetailsService_V2.getVideoDetailsServiceError(ApplicationConstants.GEO_BLOCKED_CONTENT);
        }
    }
        ...
        companyTokenService.setCompanyTokenServiceListener(new CompanyTokenService.ICompanyTokenService() {
            ...
            public void companyTokenServiceResponse(JSONObject responseBody) {
                try {
                    ...
                    iVideoDetailsService_V2.accessTokenRefreshed(ApplicationConstants.xAccessToken);
                    if(!usingSlug) {
